...
import { ProgressModal } from 'src/app/common/modals/progress-modal/progress-modal.component';
...
DoubtfireAngularJSModule.factory('ProgressModal',
  downgradeInjectable(ProgressModal));
